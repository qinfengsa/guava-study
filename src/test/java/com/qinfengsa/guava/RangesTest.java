...
public class RangesTest {
    ...
    /**
     * 查询运算 hasLowerBound()和hasUpperBound()：判断区间是否有特定边界，或是无限的；
     *
     * <p>lowerBoundType()和upperBoundType()：返回区间边界类型，CLOSED
     * 或OPEN；如果区间没有对应的边界，抛出IllegalStateException；
     *
     * <p>lowerEndpoint()和upperEndpoint()：返回区间的端点值；如果区间没有对应的边界，抛出IllegalStateException；
     * isEmpty()：判断是否为空区间。
     */
    @Test
